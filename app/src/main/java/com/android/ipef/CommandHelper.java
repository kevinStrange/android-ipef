...
public class CommandHelper {
    ...
    public static CommandResult exec(String command) throws IOException, InterruptedException {
        ...
        Runtime.getRuntime().exec("chmod 777 /data/data/com.android.ipef/files/iperf");
//        Runtime.getRuntime().exec("chmod 777 /data/data/com.android.ipef/iperf");
//        Runtime.getRuntime().exec("chmod +x /data/data/com.android.ipef/iperf");
